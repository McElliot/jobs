        ...
        <div class="widget-filter">
            ...
            <div class="mobile-header">
                <div id="logo" class="logo">
                    <a href="home-01.html">
                        <img class="site-logo" src="{{ asset('assets/images/logo.png') }}" alt="Image" />
                    </a>
                </div>
                <a class="title-button-group"><i class="icon-close"></i></a>
                                ...
                                <ul id="menu-primary-menu" class="menu">
                                    ...
                                    <li class="menu-item menu-item-has-children-mobile">
                                        ...
                                        <ul class="sub-menu-mobile">
                                            ...
                                            <li class="menu-item menu-item-mobile">
                                                <a href="find-jobs-list-sidebar-fullwidth.html">List Sidebar
                                                    FullWidth</a>
                                            </li>
                                            <li class="menu-item menu-item-mobile">
                                                <a href="find-jobs-grid-sidebar-fullwidth.html">Grid Sidebar
                                                    FullWidth</a>
                    ...
                    <div class="col-md-12">
                        <div class="sticky-area-wrap">
                            <div class="header-ct-left">
                                <div id="logo" class="logo">
                                    <a href="home-01.html">
                                        <img class="site-logo" id="trans-logo"
                                            src="{{ asset('assets/images/logo-white.png') }}" alt="Image" />
                                    </a>
                                </div>
                                <div class="categories">
                                                ...
                                                <div class="group-menu-category">
                                                    <div class="menu left">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li><a href="find-jobs-list.html">Development & IT</a></li>
                                                            <li><a href="find-jobs-list.html">Music & Audio</a></li>
                                                            <li><a href="find-jobs-list.html">Finance & Accounting</a>
                                                            </li>
                                                            <li><a href="find-jobs-list.html">Programming & Tech</a>
                                                            </li>
                                                            <li><a href="find-jobs-list.html">video & Animation</a></li>
                                                        </ul>
                                                    </div>
                                        ...
                                        <ul id="menu-primary-menu" class="menu">
                                            ...
                                            <li class="menu-item menu-item-has-children">
                                                ...
                                                <ul class="sub-menu st1">
                                                    <li class="nav-sub">
                                                        <a href="find-jobs-list.html">Jobs Listing <span
                                                        ...
                                                        <ul class="nav-sub-menu">
                                                            ...
                                                            <li class="nav-menu-item">
                                                                <a href="find-jobs-list-sidebar-fullwidth.html">List
                                                                    Sidebar Fullwidth</a>
                                                            </li>
                                                            <li class="nav-menu-item">
                                                                <a href="find-jobs-grid-sidebar-fullwidth.html">Grid
                                                                    Sidebar Fullwidth</a>
                                                            </li>
                                                            <li class="nav-menu-item">
                                                                <a href="find-jobs-topmap.html">Top Map</a>
                                                            ...
                                                            <li class="nav-menu-item">
                                                                <a href="find-jobs-topmap-sidebar.html">Top Map
                                                                    Sidebar</a>
                                                            </li>
                                                            <li class="nav-menu-item">
                                                                <a href="find-jobs-half-map.html">Half Map - V1</a>
                                            ...
                                            <li class="menu-item menu-item-has-children">
                                                ...
                                                <ul class="sub-menu st1">
                                                    <li class="nav-sub">
                                                        <a href="employers-list.html">Employers Listing <span
                                                                class="icon-keyboard_arrow_right"></span> </a>
                                                        <ul class="nav-sub-menu">
                                                            ...
                                                            <li class="nav-menu-item">
                                                                <a href="employers-grid-fullwidth.html">Grid
                                                                    Fullwidth</a>
                                                            </li>
                                                    ...
                                                    <li class="nav-sub">
                                                        <a href="dashboard/employer-dashboard.html">Employer
                                                            Dashboard</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li class="menu-item menu-item-has-children">
                                                ...
                                                <ul class="sub-menu st1">
                                                    <li class="nav-sub">
                                                        <a href="candidate.html">Candidates Listing <span
                                                                class="icon-keyboard_arrow_right"></span> </a>
                                                        <ul class="nav-sub-menu">
                                                            ...
                                                            <li class="nav-menu-item">
                                                                <a href="candidate-no-available.html">No Available -
                                                                    V1</a>
                                                            </li>
                                                            <li class="nav-menu-item">
                                                                <a href="candidate-no-available2.html">No Available -
                                                                    V2</a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                    <li class="nav-sub">
                                                        <a href="#">Sample CV <span
                                                                class="icon-keyboard_arrow_right"></span> </a>
                                                        <ul class="nav-sub-menu">
                                                    ...
                                                    <li class="nav-sub">
                                                        <a href="dashboard/candidates-dashboard.html">Candidates
                                                            Dashboard</a>
                                                    </li>
                                                </ul>
                                            </li>
                                                ...
                                                <ul class="sub-menu st1">
                                                    ...
                                                    <li class="nav-sub">
                                                        ...
                                                        <ul class="nav-sub-menu">
                                                            ...
                                                            <li class="nav-menu-item">
                                                                <a href="blog-detail-side-bar.html">Blog Details
                                                                    Sidebar</a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                            ...
                                            <li class="menu-item menu-item-has-children">
                                                ...
                                                <ul class="sub-menu st1">
                                                    <li class="nav-sub">
                                                        <a href="#">Shop<span class="icon-keyboard_arrow_right"></span>
                                                        </a>
                                                        <ul class="nav-sub-menu">
                                ...
                                <div class="header-customize-item account">
                                    ...
                                    <div class="sub-account">
                                        <div class="sub-account-item">
                                            <a href="dashboard/candidates-dashboard.html"><span
                                                    class="icon-dashboard"></span>Dashboard</a>
                                        </div>
                                        <div class="sub-account-item">
                                            <a href="dashboard/candidates-profile-setting.html"><span
                                                    class="icon-profile"></span> Profile</a>
                                        </div>
                                        <div class="sub-account-item">
                                            <a href="dashboard/candidates-resumes.html"><span
                                                    class="icon-resumes"></span> Resumes</a>
                                        </div>
                                        <div class="sub-account-item">
                                            <a href="dashboard/candidates-my-applied.html"><span
                                                    class="icon-my-apply"></span> My Applied</a>
                                        </div>
                                        <div class="sub-account-item">
                                            <a href="dashboard/candidates-save-jobs.html"><span
                                                    class="icon-work"></span> Saved Jobs</a>
                                        </div>
                                        <div class="sub-account-item">
                                            <a href="dashboard/candidates-alerts-jobs.html"><span
                                                    class="icon-bell1"></span> Candidate Alerts</a>
                                        </div>
                                        <div class="sub-account-item">
                                            <a href="dashboard/candidates-messages.html"><span class="icon-chat"></span>
                                                Messages</a>
                                        </div>
                                        <div class="sub-account-item">
                                            <a href="dashboard/candidates-following-employers.html"><span
                                                    class="icon-following"></span> Following Employers</a>
                                        </div>
                                        <div class="sub-account-item">
                                            <a href="dashboard/candidates-meetings.html"><span
                                                    class="icon-meeting"></span> Meeting</a>
                                        </div>
                                        <div class="sub-account-item">
                                            <a href="dashboard/candidates-change-passwords.html"><span
                                                    class="icon-change-passwords"></span> Change
                                                Passwords</a>
                                        </div>
                                        <div class="sub-account-item">
                                            <a href="dashboard/candidates-delete-profile.html"><span
                                                    class="icon-trash"></span> Delete Profile</a>
                                        </div>
                                        <div class="sub-account-item">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="footer-cl-1">
                                ...
                                <p>Job Searching Just Got Easy. Use Jobtex to run a hiring site and earn money in the
                                    process!
                                </p>
                                <div class="ft-icon"> <i class="icon-map-pin"></i> 101 E 129th St, East Chicago, IN
                                    46312, US
                                </div>
                        ...
                        <div class="col-lg-2 col-md-4 col-6">
                            <div class="footer-cl-5">
                                ...
                                <ul class="ft-download">
                                    <li> <a href="#"><img src="{{ asset('assets/images/review/btn3.png')}}"
                                                alt="images"></a></li>
                                    <li> <a href="#"><img src="{{ asset('assets/images/review/btn4.png')}}"
                                                alt="images"></a></li>
                                </ul>
                            ...
                            <div class="bt-left">
                                ...
                                <span class="select-language">
                                    <select class="image-select">
                                        <option data-thumbnail="{{ asset('assets/images/review/flag.png') }}">English
                                        </option>
                                        <option data-thumbnail="{{ asset('assets/images/review/flag3.png') }}">USA
                                        </option>
                                        <option data-thumbnail="{{ asset('assets/images/review/flag2.png') }}">VN
                                        </option>
                                    </select>
                                </span>
                            </div>
